...
function setupLightbox() {
  ...
  lightbox.innerHTML = `
                ...
                <img src="" alt="Expanded gallery image" loading="lazy" />
            `;
...
if (contactForm) {
  contactForm.addEventListener("submit", (event) => {
    ...
    contactSubmit.textContent = "Opening...";
    ...
    window.location.href = `mailto:xenth80314@gmail.com?subject=${encodeURIComponent(subject)}&body=${body}`;

    contactForm.reset();
    showContactStatus("Opening your email app...", "success");
